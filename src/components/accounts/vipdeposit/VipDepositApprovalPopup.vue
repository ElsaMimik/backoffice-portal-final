			...
			<form>
				...
				<div class="popup__info dottedline-top">
					<div class="popup-list">
						...
						<div class="popup__info-title">轉換比例
					...
					<div class="popup-list">
						<div class="popup__info-title">附注
							<div class="popup__info-items">2019-01-01 会员申请充值10,000, 确认需求金额无误, 进行送审.</div>
						</div>
					</div>
					<div class="popup-list">
				...
				<div class="popup__btn">
					<div class="btns">
						<button class="btns__submit">通過</button>
